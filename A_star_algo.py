...
# + l'état initial sera entré dans le programme principal, le test but est implémenté ci-dessus

# Définissons un taquin, caractérisée par sa matrice de valeurs, la matrice du taquin accident et les valeurs de l'algorithme A*, F=G+H.
class Taquin :
